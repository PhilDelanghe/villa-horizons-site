    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Les Salicaires, Vincent Lafage (Canet-en-Roussillon)', url: 'https://www.vinalia.fr/les-salicaires.html', time: '30 min', desc: 'Vincent Lafage set up here in 2016 on twenty hectares of family land, chemin du Mas Durand, a few kilometres from the sea. Organic growing, hand harvesting, and winemaking with nothing added: indigenous yeasts, no fining, no filtering, and part of the crop raised in terracotta amphorae. Around fifteen thousand bottles a year, in red, white and orange. The estate has no website of its own, the link goes to the merchant who distributes it.' },
