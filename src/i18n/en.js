    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Pôle Médical des Albères (Sorède)', time: '8 min', desc: 'Doctor, dentist, pharmacy and physiotherapists all on one site, rue des Fabriques. Useful when the village is fully booked: prescription and medicines in a single trip.' },
