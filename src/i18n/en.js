    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'The Saint-André health centre', time: '12 min', desc: 'Recently opened, and good news if you are just passing through: finding a GP as a visitor is not always straightforward in this part of France. As far as we know, this is the easiest option in the area if you fall ill on holiday.' },
          ...
          { name: 'The large pharmacy in Saint-André', time: '12 min', desc: 'Considerably bigger than the village one, with the choice that comes with it. Worth the drive if you need more than a quick fix.' },
