export default {
  ...
  vin: {
    ...
    sections: [
      ...
      {
        title: 'Our favorite estates',
        items: [
          { name: 'Our personal selection', desc: 'We share our favorite addresses, tested and approved, with guests who book. The detailed list is coming soon on this page' },
        ],
      },
    ],
  },
