export default {
  ...
  vin: {
    ...
    sections: [
      ...
      {
        title: 'Nos domaines préférés',
        items: [
          { name: 'Notre sélection personnelle', desc: 'Nous partageons nos adresses préférées, testées et approuvées, avec les voyageurs qui réservent. La liste détaillée arrive bientôt sur cette page' },
        ],
      },
    ],
  },
