    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Château de Villeclare (Palau-del-Vidre)', time: '14 min', desc: 'Trente hectares en agriculture biologique sur le piémont des Albères, en Côtes du Roussillon et Côtes Catalanes. C\'est l\'une des propriétés de la famille Jonquères d\'Oriola, vieille maison catalane qui exploite plusieurs domaines et signe plusieurs marques dans la région. Le château templier du XIIe siècle est bâti sur des ruines romaines, entouré d\'arbres tricentenaires, avec le Canigou en toile de fond. Dégustation gratuite.' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'La maison médicale de Saint-André', time: '12 min', desc: 'Ouverte récemment, et c\'est une bonne nouvelle pour qui passe : trouver un généraliste quand on est de passage n\'est pas toujours simple dans le département. À notre connaissance, c\'est la solution la plus accessible du secteur si vous tombez malade en vacances.' },
          ...
          { name: 'La grande pharmacie de Saint-André', time: '12 min', desc: 'Nettement plus grande que celle du village, avec le choix qui va avec. À viser si vous cherchez autre chose qu\'un dépannage.' },
