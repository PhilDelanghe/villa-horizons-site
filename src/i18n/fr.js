    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Pôle Médical de Saint-André', time: '12 min', desc: 'Rue Jean Jaurès. La maison médicale y a ouvert récemment, et c\'est une bonne nouvelle pour qui passe : trouver un généraliste en vacances n\'est pas toujours simple dans le département. C\'est à notre connaissance la solution la plus accessible du secteur si vous tombez malade pendant votre séjour.' },
