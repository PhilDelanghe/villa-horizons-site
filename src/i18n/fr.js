export default {
  ...
  villa: {
    ...
    bedrooms: [
      ...
      { name: 'Chambre parents vue mer', desc: 'Lit queen 160 × 200, balcon vue mer, communicante avec la chambre enfants.' },
      { name: 'Chambre double vue mer', desc: 'Lit double 140 × 190 en fer forgé, accès balcon vue mer.' },
  ...
  galerie: {
    ...
    parents: 'La chambre parents vue mer',
    fer: 'La chambre double vue mer',
